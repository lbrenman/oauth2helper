// src/icons.js
// Small inline SVG icon set (stroke-based, currentColor — themes with
// light/dark automatically via CSS). Server-rendered directly into the
// HTML, no client-side JS needed to draw or swap them.
